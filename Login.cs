...
namespace BankClone2
{
    public class Login
    {
        ...
        public static void LogIn(List<Customer> customerList, List<Admin> adminList)
        {
            ...
            {
                CustomerLoginForTest(customerList);
            }
        }

        public static void CustomerLoginForTest(List<Customer> customerList)
        {
            for (TriesLeft = 3; TriesLeft > 0;)
            {
                Console.Clear();
                ...
                else
                {
                    ...
                    Thread.Sleep(1500);
                    TriesLeft = 3;
                    uCheck.Menu(customerList); // HÄR skickas användaren till sin sida
                    break;
                }
            }
        }
